    ...
    return (
        <div className="flex space-x-2 p-6">
            ...
            <div className="flex-1">
                ...
                { editing ? (
                    <CategoryForm category={category} className="mt-2" setEditing={setEditing}/>
                ) : (
            ...
            <Dropdown>
                ...
                <Dropdown.Content>
                    ...
                    <Dropdown.Link as="button" href={route('category.destroy', category)} method="delete"> Delete</Dropdown.Link>
                </Dropdown.Content>
            </Dropdown>
        </div>
    )
