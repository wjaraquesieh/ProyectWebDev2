...
export default function PetsTypeItem ({ petsType }){
    ...
    return (
        <div className="flex space-x-2 p-6">
            ...
            <div className="flex-1">
                ...
                { editing ? (
                    <PetsType petsType={petsType} className="mt-2" setEditing={setEditing}/>
                ) : (
            ...
            <Dropdown>
                ...
                <Dropdown.Content>
                    ...
                    <Dropdown.Link as="button" href={route('petsType.destroy', petsType)} method="delete"> Delete</Dropdown.Link>
                </Dropdown.Content>
            </Dropdown>
        </div>
    )
